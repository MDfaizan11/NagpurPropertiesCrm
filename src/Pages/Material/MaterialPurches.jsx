...
function MaterialPurches() {
  ...
  async function GetAllVendorName() {
    try {
      ...
      console.log(response.data);
      setAllVendorName(response.data);
    } catch (error) {
      console.log(error);
    }
  }
  ...
  const handleSiteChange = (e) => {
    ...
    if (selectedValue === "add-site") {
      navigate("/Site"); // Change route if needed
    } else {
      setSiteName(selectedValue);
    }
  };
