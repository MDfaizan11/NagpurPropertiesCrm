      ...
      <div className="financeparty-parties-section">
        {loading ? (
          ...
          <>
            ...
            <div className="financeparty-table-container">
              <table className="financeparty-table">
                <thead>
                  <tr>
                    <th>Account Name</th>
                    <th className="financeparty-table-email">Email</th>
                    <th className="financeparty-table-contact">Contact</th>
                    <th className="financeparty-table-address">Address</th>
                    <th>Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredParties.map((party, index) => (
                    <tr key={index}>
                      <td data-label="Account Name">{party.accountName}</td>
                      <td
                        data-label="Email"
                        className="financeparty-table-email"
                      >
                        {party.emailId}
                      </td>
                      <td
                        data-label="Contact"
                        className="financeparty-table-contact"
                      >
                        {party.contactNo}
                      </td>
                      <td
                        data-label="Address"
                        className="financeparty-table-address"
                      >
